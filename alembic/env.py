...
from app.services.db.database import Base  # Добавили импорт нашей мета-БД
from app.services.db.models import *  # Добавили импорт модели, чтобы она инициализировалась, но она не используется
